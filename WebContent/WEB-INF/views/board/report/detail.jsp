					...
					<div>
						...
						<div class="ed-wrapper">
							<c:if test="${sessionScope.id.equals(b.writerId)}">
								<a href="report-edit?no=${b.no}" class="btn">수정</a>
								<a href="report-del?no=${b.no}" class="btn">삭제</a>
							</c:if>
						</div>
					</div>
				</div>
									...
									<div class="cmt-info">
										...
										<c:if test="${c.writerId.equals(b.writerId)}">
											<div class="cmt-btn-wrapper">
												<span> <a href="report-cmt-edit?no=${c.no}"
													class="btn-a">수정</a> <a href="report-cmt-del?no=${c.no}"
													class="btn-a">삭제</a>
												</span>
											</div>
										</c:if>
