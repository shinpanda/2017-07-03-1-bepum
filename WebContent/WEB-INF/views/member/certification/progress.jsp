...
<body>
	...
	<header id="header">
		<div class="content-container clearfix">
			<a href="/bepum/index"><img src="/bepum/images/1616.png"
				id="logo" alt="베품"></a>
			<section id="menu-container">
				<nav class="menu-wrapper">
					...
					<ul class="main-menu">
						...
						<li><a href="/bepum/member/certification-progress" class="on">베푸미
								되기</a> <!-- 임시 -->
							<ul class="sub-menu">
								<li><a href="/bepum/member/certification-progress"
									class="on">진행 상황</a></li>
				...
				<nav class="menu-wrapper">
					<ul id="login">
						<li><a href="" onclick="javascript:showPopup();"
							class="btn-border">Sign in</a></li>
					</ul>
				</nav>
				<div id="sub-bg"></div>
			</section>
	...
	<div id="body">
		...
		<div class="content-container">
			...
			<div class="certfi-container document-container">
				...
				<div class="document-certification1">재심사가 필요한 서류의 경우, [재심사 필요]
					버튼을 눌러 다시 제출해주세요.</div>
				<div class="document-wrapper">
					<div class="application-form-wrapper clearfix">
						...
						<div class="progress">
							<span>제출 전</span> <span>제출 완료</span> <span>심사 중</span> <span>심사
								완료</span> <span class="progress-status"> <a href="#layer2"
								class="btn-recheck">재심사 필요</a> <!-- 재심사필요 팝업 -->
					...
					<div class="family-rc-wrapper clearfix">
						...
						<div class="progress">
							...
							<span class="progress-status"> <a href="#layer3"
								class="btn-recheck">재심사 필요</a>
							</span>
							<!-- 재심사필요 팝업 -->
			...
			<div class="hc-wrapper clearfix">
				...
				<div class="progress">
					<span>제출 전</span> <span>제출 완료</span> <span>심사 중</span> <span>심사완료</span>
					<span class="progress-status"><a href="#layer4"
						class="btn-recheck">재심사 필요</a></span>
			...
			<div id="layer2" class="pop-layer"
				...
				<div class="pop-container">
					<div class="pop-conts">
						<!--content //-->
						<p class="ctxt mb20">
							<b>***재심사 요청 사유***</b><br> <br> 본인 인증에 사용된 성함과 서류상의 성함이
