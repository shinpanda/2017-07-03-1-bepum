							...
							<form accept-charset="utf-8" action="#" class="simform">
								<div class="sminputs">
									<div class="input full">
										...
										<input class="string optional" maxlength="10" id="user-name"
								...
								<div class="sminputs">
									...
									<div class="input string optional">
										...
										<input class="string optional" maxlength="255"
											id="user-pw-repeat" placeholder="비밀번호확인" type="password"
											size="50" />
									</div>
								</div>
								<div class="sminputs">
									<div class="input full">
										...
										<input class="string optional" maxlength="10" id="user-email"
								...
								<div class="sminputs">
									<div class="input string optional" id="user-gender">
										...
										<label>남자<input class="option-input radio"
											name="user-gender" type="radio" value="남"></label>
									</div>
									<div class="input string optional">
										...
										<label>여자<input class="option-input radio"
											name="user-gender" type="radio" value="여" checked></label>
									</div>
								</div>
								...
								<div class="simform__actions">
									<input class="sumbit" name="commit" type="sumbit" value="가입신청" />
								</div>
							</form>
						</div>
					</div>
