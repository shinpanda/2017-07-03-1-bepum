...
<body>
	...
	<div class="content-container clearfix">
		<a href="${p}/index"><img src="${p}/images/1616.png" id="logo"
			alt="베품" /></a>
		<section id="menu-container"> <nav class="menu-wrapper">
		...
		<ul class="main-menu">
			...
			<c:if test="${sessionScope.grade >= 0}">
				<li><a href="${p}/member/certification-progress">베푸미 되기</a>
				<!-- 임시 -->
					<ul class="sub-menu hidden">
		...
		<ul id="login">
			...
			<c:if test="${!empty sessionScope.id}">
				<li class="nav-item dropdown"><a href="#"
					class="btn-border nav-link">${name}님</a>
					<div class="submenu">
						<ul class="submenu-items">
							<li class="submenu-item"><a href="${p}/member/profile"
								class="submenu-link">내 정보</a></li>
							<li class="submenu-item"><a href="" class="submenu-link">메시지</a></li>
							<c:if test="${grade == 999}">
								<li class="submenu-item"><a href="${p}/admin/index"
									class="submenu-link">관리자페이지</a></li>
							</c:if>
							<li class="submenu-item"><a href="${p}/member/logout"
								class="submenu-link">로그아웃</a></li>
						</ul>
					</div></li>
			</c:if>
		</ul>
